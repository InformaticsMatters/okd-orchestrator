...
# Environment variables for GCE Cluster deployment.
#
# Copy as `setenv.sh`, edit and then install with `source setenv.sh`

# -----------------------------------------------------------------------------
# The following variables are required to compile machine images on GCE,
# orchestrate the cluster.
# -----------------------------------------------------------------------------

export TF_VAR_gce_project=SetMe
export TF_VAR_gce_project_number=SetMe
export TF_VAR_gce_user=SetMe

# -----------------------------------------------------------------------------
# The following variables are required for S3 state storage.
# -----------------------------------------------------------------------------
